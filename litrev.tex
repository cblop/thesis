...
\citep{harris1959basic} makes the case for just three types of plot, having
...
Christopher Brooker describes seven basic plots, where each may have either a
happy or unhappy ending \cite{booker2004seven}:
\begin{itemize}
...
Georges Polti famously divides narratives into the \emph{thirty-six dramatic
  situations}\cite{polty1921thirty}, derived from his analysis of classical
...
example, the protagonist's situation improves little by little, jumping up in
increments, before being ``cast down'' to a terrible situation towards the end
of the story.
...
concept (sample size 19, see section~\ref{}). This means that tropes are a

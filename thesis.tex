...
Rather than using a formalism to describe the components of a story, the
approach suggested in this thesis is to describe the parts of the story
\emph{informally}, using a controlled natural language syntax. Once the parts of
...
\item The use of \textbf{Institutions as Story Worlds} is described in
  ...
  the \textbf{[CMN 2015]} conference paper in the list of papers in section~\ref{sec:papers}.

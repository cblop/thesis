...
\caption{The view when the user clicks the \emph{arrange} tab}\label{fig:sb1}
\end{figure}
...
\subsection{Creating a story with StoryBuilder: The Hero's Journey}
\subsubsection{The Departure}

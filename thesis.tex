...
story.\mnote{Removed: author choosing to use intelligent agents}
...
\mnote{Re-expressed contributions as norms for stories and tropes}
...
\mnote{Moved mention \& description of TropICAL to here}
...
\mnote{Removed first sentence}

\citet{schank1990tell} argues that stories may be a useful way for humans to
better remember a series of events, when compared to simply reciting them as a
list of facts. Mentalists and creative students use storytelling mnemonic
techniques to help them memorise large lists of difficult-to-remember facts with
perfect recall. Training simulations make the use of stories taking place in immersive environments to help trainees to master new routines and techniques. These stories always follow a fixed pattern, however, unlike the mnemonic stories that people create to memorise information, which are highly personalised to the practitioner.

Could a narrative that dynamically reacts to the decisions of the audience
better enable them to remember information when compared with a static,
unpersonalised narrative? \mnote{Rephrased as a question} Preliminary work has been done in collaboration with the Bishop's Palace in

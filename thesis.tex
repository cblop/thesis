...
Interactive storytelling is the method of telling a story which its consumer can
meaningfully change through interaction.
...
narrative. Researchers still use narrative models created as early as 1928
by structuralists such as Propp~\cite{propp1968morphology}, due to the lack of
new alternatives that improve on these early attempts to formalise narrative.

This thesis introduces the concept of \emph{tropes} as formal, composable components
...
detailed explanations appear in sections~\ref{sec:tropes-intro} and~\ref{sec:tropes}.

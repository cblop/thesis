...
\emph{``go_hero_landOfAdventure''}. The reason for this labelling is due to the
fact that once the controlled natural language syntax has been translated to its
formal representation, it is difficult to reverse the process. The edges between

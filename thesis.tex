...
We built StoryBuilder as a graphical user interface to enhance the functionality of
...
of our answer set solver (as described in Section~\ref{}) to create a tree
...
is blank in this initial screenshot). Figure~\ref{fig:st-edit-ann} shows the
...
A particularly important feature of the visualisation is that the name of the
trope that an event follows appears along its corresponding line. In the example
...
Search} trope are connected with a blue arrow. This allows the user to visualise
...
\subsection{Creating a story with StoryBuilder: A Noir Detective Story}
...
% TODO forward ref to transcripts in appendix: 1
...
\paragraph{Different characters in different tropes}
Participant A, line~\ref{lne:feature1a}
Participant D, line~\ref{lne:feature1d}
\paragraph{State management}
Participant A, lines~\ref{lne:feature2a},~\ref{lne:feature2a2}~\ref{lne:feature2a3}
Participant B, line~\ref{lne:feature2b}
Participant D, line~\ref{lne:feature2d}
Participant F, line~\ref{lne:feature2f}
\paragraph{Event with two agents}
Participant A, line~\ref{lne:feature3a}
Participant D, line~\ref{lne:feature3d}
Participant G, line~\ref{lne:feature3g}
\paragraph{Event semantics}
Participant A, line~\ref{lne:feature4a}
Participant D, lines~\ref{lne:feature4d},~\ref{lne:feature4d2}
Participant H, lines~\ref{lne:feature4h},~\ref{lne:feature4h2}
\paragraph{Other types of entities}
Participant B, line~\ref{lne:feature5b}
Participant F, line~\ref{lne:feature5f}
\paragraph{Subject must be an agent}
Participant B, line~\ref{lne:feature6b}
Participant D, lines~\ref{lne:feature6d},~\ref{lne:feature6d2}
\paragraph{Story structure}
Participant C, line~\ref{lne:feature7c}
Participant F, line~\ref{lne:feature7f}
Participant G, line~\ref{lne:feature7g}
\paragraph{Conditionals}
Participant D, line~\ref{lne:feature8d}
Participant H, line~\ref{lne:feature8h}

\subsubsection{Syntax}
\paragraph{Spaces in words}
Participant A, line~\ref{lne:syntax1a}
Participant D, lines~\ref{lne:syntax1d},~\ref{lne:syntax1d2}
\paragraph{Using any verb}
Participant A, line~\ref{lne:syntax2a}
Participant B, line~\ref{lne:syntax2b}
Participant F, lines~\ref{lne:syntax2f}
Participant G, lines~\ref{lne:syntax2g}
\paragraph{Use of ``the''}
Participant A, line~\ref{lne:syntax3a}
Participant B, lines~\ref{lne:syntax3b},~\ref{lne:syntax3b2}
Participant C, line~\ref{lne:syntax3c}
Participant D, line~\ref{lne:syntax3d}
Participant E, lines~\ref{lne:syntax3e},~\ref{lne:syntax3e2}
Participant F, line~\ref{lne:syntax3f}
Participant H, line~\ref{lne:syntax3h}
\paragraph{Entity declarations}
Participant A, line~\ref{lne:syntax4a}
Participant C, line~\ref{lne:syntax4c}
Participant D, lines~\ref{lne:syntax4d},~\ref{lne:syntax4d2}
\paragraph{Capitalisation}
Participant B, lines~\ref{lne:syntax5b},~\ref{lne:syntax5b2}
Participant C, lines~\ref{lne:syntax5c},~\ref{lne:syntax5c2},~\ref{lne:syntax5c3},~\ref{lne:syntax5c4}
Participant D, lines~\ref{lne:syntax5d},~\ref{lne:syntax5d2},~\ref{lne:syntax5d3},~\ref{lne:syntax5d4}
Participant E, line~\ref{lne:syntax5e}
Participant F, lines~\ref{lne:syntax5f},~\ref{lne:syntax5f2}

\subsubsection{Limitations}
\paragraph{Five event limit}
Participant A, line~\ref{lne:bug1a}
Participant C, line~\ref{lne:bug1c}
Participant D, line~\ref{lne:bug1d}
Participant E, lines~\ref{lne:bug1e},~\ref{lne:bug1e2}
Participant G, lines~\ref{lne:bug1g},~\ref{lne:bug1g2}
Participant H, lines~\ref{lne:bug1h},~\ref{lne:bug1h2}
\paragraph{Branch length limit}
Participant A, line~\ref{lne:bug2a}
Participant D, lines~\ref{lne:bug2d},~\ref{lne:bug2d2}
Participant F, line~\ref{lne:bug2f}
Participant G, line~\ref{lne:bug2g}
\paragraph{Subtrope at end}
Participant A, line~\ref{lne:bug3a}
Participant B, line~\ref{lne:bug3b}
Participant C, line~\ref{lne:bug3c}
Participant E, line~\ref{lne:bug3e}
Participant H, lines~\ref{lne:bug3h}
\paragraph{Error messages}
Participant B, lines~\ref{lne:bug4b}
Participant G, line~\ref{lne:bug4g}

\subsubsection{Usability}
\paragraph{Ease of use}
Participant A, line~\ref{lne:use1a}
Participant B, line~\ref{lne:use1b}
Participant D, lines~\ref{lne:use1d},~\ref{lne:use1d2}
Participant E, line~\ref{lne:use1e}
Participant F, lines~\ref{lne:use1f},~\ref{lne:use1f2}
Participant G, lines~\ref{lne:use1g}
\paragraph{Visualisation}
Participant B, lines~\ref{lne:use2b},~\ref{lne:use2b2},~\ref{lne:use2b3}
Participant E, lines~\ref{lne:use2e},~\ref{lne:use2e2},~\ref{lne:use2e4}
\paragraph{Tropes}
Participant C, lines~\ref{lne:use3c},~\ref{lne:use3c2}
Participant E, lines~\ref{lne:use3e},~\ref{lne:use3e2},~\ref{lne:use3e3}
Participant F, lines~\ref{lne:use3f}
...
\textbf{Participant:} How does it deal with spaces?\syntax{Spaces in words}\label{lne:syntax1a}
...
Lair.\feature{State management}\label{lne:feature2a}

\textbf{Myself:} Yeah.

\textbf{Participant:} I'm just trying to remember the exact syntax. It's
"goes"?\syntax{Using any verb}\label{lne:syntax2a}
...
with "T", that's what I've missed off.\syntax{Use of ``the''}\label{lne:syntax3a}
...
is quite intuitive.\usability{Ease of use}\label{lne:use1a}
...
be anywhere?\syntax{Entity definitions}\label{lne:syntax4a}
...
Weapon"?\feature{Event with two agents}\label{lne:feature3a}
...
wrong?\feature{State management}\label{lne:feature2a2}
...
Weapon".\bug{Five event limit}\label{lne:bug1a}
...
that's just a flaw in my own story!\feature{Event semantics}\label{lne:feature4a}
...
just testing out very simple branching.\bug{Branch length limit}\label{lne:bug2a}
...
exercise.\bug{Subtrope at end}\label{lne:bug3a}
...
statement?\feature{State management}\label{lne:feature2a3}
...
bit.\bug{Error messages}\label{lne:bug4b}
...
\textbf{Participant:} I noticed that you've got some capitals in there, are the capitals important to the running of the program?\syntax{Capitalisation}\label{lne:syntax5b}
...
Adventure" works.\syntax{Use of ``the''}\label{lne:syntax3b}
...
that do I?\syntax{Using any verb}\label{lne:syntax2b}
...
\textbf{Myself:} No, it should show the first event, "David drinks Coffee", but it wants the Coffee with a capital "C".\syntax{Capitalisation}\label{lne:syntax5b2}
...
"role", "place" or "object".\feature{Other types of entities}\label{lne:feature5b}
...
say "The Sun shines", that might be better.\feature{State management}\label{lne:feature2b}
...
object, The Sun shines", see if that works.\syntax{Use of ``the''}\label{lne:syntax3b2}
...
er\ldots{}\feature{Subject must be an agent}\label{lne:feature6b}
...
combine tropes together.\bug{Subtrope at end}\label{lne:bug3b}
...
\textbf{Participant:} I like the idea of it being able to spit out all permutations. You know, I was looking at some Google layout algorithm which compiled pictures of dinosaurs using botanical (garbled) from the past.\usability{Visualisation}\label{lne:use2b}
...
\textbf{Myself:} Yeah, that's fine. I think Knife has to be capital "K".\syntax{Capitalisation}\label{lne:syntax5c}
...
\textbf{Participant:} With a capital Knife? Capital K?\syntax{Capitalisation}\label{lne:syntax5c2}
...
\textbf{Myself:} So it doesn't like "Knife of Immense Power", but "Knife of Power"\ldots{} it's OK if "Power" has a capital "P". So hang on, I think that's what I've done, I've said "Every word has to be capitalised". But then "of" is OK.\syntax{Capitalisation}\label{lne:syntax5c3}
...
happens.\syntax{Entity declarations}\label{lne:syntax4c}
...
possibilities, combining these tropes together.\syntax{Use of ``the''}\label{lne:syntax3c}
...
\textbf{Participant:} Capital "Then", or\ldots{}?\syntax{Capitalisation}\label{lne:syntax5c4}
...
that "arrange" tab from before.\bug{Subtrope at end}\label{lne:bug3c}
...
\textbf{Participant:} I'd say yes, but I think that it also helps that I am a creative writer, so I automatically think of a story pattern.\usability{Tropes}\label{lne:use3c}

\textbf{Myself:} Hmm, OK.

\textbf{Participant:} So like creating a story pattern on the builder is a lot easier, because I know how to, like, combine them. So in my head, I always view that the Princess will meet the Rogue eventually. And I had to create the second trope.\usability{Tropes}\label{lne:use3c2}
...
\textbf{Participant:} Yeah, but like say also in storytelling you don't reveal everything at once. So like, normally she'd be a princess until it's suddenly revealed that she's a ninja.\feature{Story structure}\label{lne:feature7c}
...
\textbf{Participant:} Is it "The" Home is a place?\syntax{Use of ``the''}\label{lne:syntax3d}
...
going to be OK with that?\syntax{Spaces in words}\label{lne:syntax1d}
...
can you go to a second level of nesting?\bug{Branch length limit}\label{lne:bug2d}
...
this. So it's kind of less predictable in a way.\usability{Ease of use}\label{lne:use1d}
...
interpreter to do something clever and understand it?\syntax{Spaces in words}\label{lne:syntax1d2}
...
\textbf{Myself:} And I think it has to be capital "T" as well.\syntax{Capitalisation}\label{lne:syntax5d}
...
place?\feature{Subject must be an agent}\label{lne:feature6d}
...
beginning.\syntax{Entity declarations}\label{lne:syntax4d}
...
\textbf{Myself:} Uhh\ldots{} you can say it. It won't have any semantic meaning, but you can do two spaces, then an "Or the Villain goes nowhere". But then nowhere isn't a place. It would probably interpret that as a separate verb.\feature{Event semantics}\label{lne:feature4d}
...
same name, in two different tropes? How does it handle that?\feature{Different
  characters in different tropes}\label{lne:feature1d}
...
Smartphone.\syntax{Entity declarations}\label{lne:syntax4d2}
...
structure. I think that makes a lot of sense, Matt.\usability{Ease of use}\label{lne:use1d2}
...
declaring that they started somewhere.\feature{State management}\label{lne:feature2d}
...
that'll be interesting.\feature{Subject must be an agent}\label{lne:feature6d2}
...
\textbf{Myself:} There's going to have to be a capital "H". Yeah, exactly.\syntax{Capitalisation}\label{lne:syntax5d4}
...
will\ldots{} that's fine.\bug{Five event limit}\label{lne:bug1d}
...
like\ldots{}\feature{Event with two agents}\label{lne:feature3d}

\textbf{Myself:} You can, but again it won't have any semantic\ldots{} oh yeah, it would. Kind of. It would give an agent permission to give something to another agent. So it would work, it would compile and work. Yeah, so actually that would be fine.\feature{Event semantics}\label{lne:feature4d2}
...
things beforehand?\usability{Ease of use}\label{lne:use1e}
...
this task.\bug{Five event limit}\label{lne:bug1e}
...
\textbf{Myself:} Yeah, "Home" has to be capital "H". Yeah, that's right.\syntax{Capitalisation}\label{lne:syntax5e}
...
wonder if it's expecting "THE Lair is a place".\syntax{Use of ``the''}\label{lne:syntax3e}
...
you had.\syntax{Use of ``the''}\label{lne:syntax3e2}
...
happen.\bug{Five event limit}\label{lne:bug1e2}
...
end.\bug{Subtrope at end}\label{lne:bug3e}
...
define, right?\feature{Other types of entities}\label{lne:feature5f}
...
/ a"?\syntax{Use of ``the''}\label{lne:syntax3f}
...
\textbf{Myself:} That wouldn't work, no, it has to be a capital "P".\syntax{Capitalisation}\label{lne:syntax5f}
...
your character roles.\syntax{Using any verb}\label{lne:syntax2f}
...
\textbf{Myself:} Oh. So if you put "The Mentor goes to the Castle", and make sure the Castle is a capital "C".\syntax{Capitalisation}\label{lne:syntax5f2}
...
second step where the Hero is already at the castle.\bug{Branch length limit}\label{lne:bug2f}
...
number.\feature{State management}\label{lne:feature2f}
...
\textbf{Myself:} Yeah, that is a problem. And that's actually why we have this ability to put the tropes inside the tropes. So once it gets really crazy, you can just refer to another trope that already has those\ldots{}\usability{Tropes}\label{lne:use3f}
...
difficult to say because I know how programming works.\usability{Ease of use}\label{lne:use1f}
...
there to help them use the program.\usability{Ease of use}\label{lne:use1f2}
...
so on. So you can use basically any verb in there?\syntax{Using any verb}\label{lne:syntax2g}
...
to Sleeping Beauty"?\feature{Event with two agents}\label{lne:feature3g}
...
\textbf{Myself:} No\ldots{} a very un-useful error.\bug{Error messages}\label{lne:bug4g}
...
one action, basically?\bug{Branch length limit}\label{lne:bug2g}
...
problem.\usability{Ease of use}\label{lne:use1g}
...
special happen after that?\feature{Event semantics}\label{lne:feature4h}
...
\textbf{Participant:} Um, once we had talked about the fact that "die" doesn't have any special semantics, yes, that is pretty much what I expected.\feature{Event semantics}\label{lne:feature4h2}
...
happens, Hero takes object".\bug{Subtrope at end}\label{lne:bug3h}
...
Hello?\bug{Five event limit}\label{lne:bug1h}
...
little trickier.\bug{Five event limit}\label{lne:bug1h2}
...
map" there, instead of "find the map".\syntax{Use of ``the''}\label{lne:syntax3h}

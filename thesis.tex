...
\item A \textbf{Literature Review}.
  ...
  (section~\ref{sec:implementations}).\mnote{Changed wording}
...
\item Using \textbf{Tropes as Story Components}
  ...
  upon existing narrative formalisms.\mnote{reworded}This is linked to the work in
  ...
  translation process.\mnote{Explained the UI metaphor}
...
\item Our specification of tropes as social institutions allows the character
  ...
  of the story in times of high emotional distress, describing work done as part of the \textbf{[AISB
    2015]} paper.\mnote{Added justification to fit the narrative of using social
  norms to allow autonomy}
...
\item
  ...
  story.\mnote{Added motivation} For

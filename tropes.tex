...
such as the ``Hero's Journey''. Another example of this would be \textbf{Freytag's
Pyramid} (also known as the Three-Act Structure) shown in fig.~\ref{fig:freytag}, which describes the shape of a
